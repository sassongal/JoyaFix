...
class SoundManager {
    ...
    func playSound(_ filename: String) -> Bool {
        ...
        // Priority 1: Try Bundle.module (SPM development/testing)
        var soundURL: URL?
        #if !os(iOS) // Bundle.module generated by SPM
        soundURL = Bundle.module.url(forResource: nameWithoutExt, withExtension: "wav")
        #endif
        
        // Priority 2: Try Bundle.main (final app bundle)
        if soundURL == nil {
            soundURL = Bundle.main.url(forResource: nameWithoutExt, withExtension: "wav")
        }
        
        // Fallback: Try with the full filename as-is
        if soundURL == nil {
